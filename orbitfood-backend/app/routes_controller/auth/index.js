...
router.post('/customer-login', authLimiter, customerLoginValidator, controller.customerlogin);

// Send OTP route
router.post('/customer/send-otp', authLimiter, controller.sendOtp);

//  Corrected Create customer route (was: createCustomer)
router.post('/customer-create', authLimiter, createCustomerValidator, controller.create);
